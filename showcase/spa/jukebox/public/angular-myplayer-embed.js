/* global YT */
// https://cdn.rawgit.com/brandly/angular-youtube-embed/master/src/angular-youtube-embed.js

var myplayer = angular.module('myplayer-embed', ['ng']);

myplayer.service ('youtubeEmbedUtils', ['$window', '$rootScope', function ($window, $rootScope) {
    var Service = {}
...
myplayer.directive('youtubeVideo', ['youtubeEmbedUtils', function (youtubeEmbedUtils) {
    var uniqId = 1;
...
myplayer.directive('mp3Player',function($interval) {
    return {
        restrict:'A',
        scope: {
            audobj: '='
        ...
        controller: function($scope){
            ...
            $scope.audio.playMp3 = function(){
                $scope.audio.play();
            };
            $scope.audio.stopMp3 = function(){
                $scope.audio.pause();
            };
            $interval(function(){
